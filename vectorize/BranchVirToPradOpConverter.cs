...
namespace Vectorization.Converters
{
    public class BranchVirToPradOpConverter
    {
        ...
        private string ConvertExpression(BranchVirExpression expression, StringBuilder sb, int indent)
        {
            return expression switch
            {
                BranchVirOperation operation => ConvertOperation(operation, sb, indent),
                BranchVirBranch branch => ConvertBranch(branch, sb, indent),
                BranchVirVariable variable => ConvertVariable(variable, sb, indent),
                BranchVirConstant constant => $"new PradOp(new Tensor({constant.Value})).Result",
